...
<div class="flex flex-col md:flex-row md:items-center md:justify-between gap-3 mb-6">
  <div>
    <h1 class="text-2xl font-bold">Kelola {{ $type === 'informasi' ? 'Informasi' : 'Berita' }}</h1>
        ...
        <tr class="border-t border-slate-100">
          ...
          <td class="px-4 py-3">
            <div class="flex items-center justify-end gap-2">
              <a href="{{ route('admin.posts.edit', $post) }}" class="text-xs px-3 py-1.5 rounded-md bg-slate-100 text-slate-700">Edit</a>
