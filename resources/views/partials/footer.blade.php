  ...
  <div class="max-w-6xl mx-auto px-6 pt-14 pb-10 grid grid-cols-1 md:grid-cols-4 gap-10 text-sm">
    ...
    <div>
      ...
      <div class="mt-4 pt-4 border-t border-slate-800">
        ...
        <div class="text-white text-sm font-semibold">{{ setting('contact.phone', '022 – 8750 6667') }}</div>
      </div>
      <a href="https://wa.me/{{ setting('contact.wa', '02287506667') }}" target="_blank" rel="noopener noreferrer" class="mt-4 inline-flex items-center gap-2 bg-green-600 hover:bg-green-500 transition text-white text-xs font-semibold px-3 py-2 rounded-lg">
